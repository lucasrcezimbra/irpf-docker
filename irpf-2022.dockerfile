...
RUN wget https://downloadirpf.receita.fazenda.gov.br/irpf/2022/irpf/arquivos/IRPF2022-1.3.zip -O IRPF2022.zip
...
CMD ["java", "-Xms128M", "-Xmx512M", "-jar", "/opt/IRPF2022/irpf.jar"]
